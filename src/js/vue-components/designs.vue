<template>
  <a :href="designUrl" target="_blank" class="light:hover:bg-primary group light:text-white light:hover:text-black lg:h-[50dvh] lg:hover:z-51">
    <div class="anim-extrude relative z-10 grid gap-5 p-15 lg:h-full lg:grid-rows-[50%] lg:items-center">
      ...
      <div class="flex flex-col gap-5 self-end transition-all duration-100 ease-in-out">
        <Tags :tags="designTags" :show-icons="true" class="opacity-100 lg:group-hover:hidden lg:group-hover:opacity-0" />
