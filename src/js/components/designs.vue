<template>
  <a :href="designUrl" target="_blank" class="group light:bg-[var(--black)] design active relative z-10 grid h-fit gap-5 rounded-4xl p-10 hover:z-100 lg:h-125 lg:items-center">
