<template>
  <a :href="designUrl" target="_blank" class="group design relative z-10 grid lg:h-150 gap-5 rounded-4xl p-10 hover:z-100 lg:items-center">
    <h4 class="light:text-[color:var(--white)] flex gap-3">{{ designName }}</h4>
    <div class="top-75 right-10 left-10 bottom-10 flex flex-wrap gap-5 self-end lg:absolute lg:flex lg:group-hover:hidden">
