<template>
  <a
    ...
    class="group w-full shrink-0 overflow-hidden rounded-4xl text-primary hover:bg-design-card-active hover:text-on-design-card-active effects:lg:hover:z-51 no-effects:lg:hover:z-51 max-md:[&.design-active]:bg-design-card-active max-md:[&.design-active]:text-on-design-card-active"
  >
    <div
