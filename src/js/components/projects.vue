<template>
  <div class="item light:bg-[var(--white)] project absolute col-span-1 flex h-dvh w-full flex-col gap-5 rounded-4xl border border-solid border-black will-change-transform">
