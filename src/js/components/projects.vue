<template>
  <div class="light:bg-[var(--black)] overflow-hidden



 item project absolute col-span-1 flex h-full w-full flex-col rounded-4xl border border-solid border-white will-change-transform lg:h-full">
    <div class="flex h-full flex-col justify-between gap-5">
      <h3 class="lg:w-[80%] p-5">{{ projectName }}</h3>
