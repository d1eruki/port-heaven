...
(async () => {
  try {
    if (hwOn) {
      ...
      if (screenLg) {
        imports.push(import("./js/libraries/lenis"), import("./js/libraries/vanilla-tilt"), import("./js/custom/hero-image-effect"), import("./js/custom/cursor"), import("./js/custom/scroll-speed"), import("./js/custom/horizontal-scroll"));
      }
